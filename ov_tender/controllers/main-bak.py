...
class WebsiteSale(ProductConfiguratorController):
    ...
    def _get_mandatory_billing_fields(self):
        return ["name", "tb","keywords_ids", "keys","email", "street", "city", "country_id"]

    def _get_mandatory_shipping_fields(self):
        return ["name", "tb","keywords_ids", "keys","street", "city", "country_id"]
    ...
    def address(self, **kw):
        ...
        if 'submitted' in kw:
            ...
            #print("THISSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS")
            if errors:
