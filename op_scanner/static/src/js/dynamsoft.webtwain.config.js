...
Dynamsoft.WebTwainEnv.ProductKey = 't0068MgAAADJiFQ+iq+mzUfZbBl8vejxOEaWG9pZJ6P1+MTv6zzwFHe5NVlfaHmz6fgarVRSObv+bJF0fJEZWxSOV+BXsdHo=';

///
Dynamsoft.WebTwainEnv.Trial = true;

///
Dynamsoft.WebTwainEnv.ResourcesPath = '/op_scanner/static/src/js/';
